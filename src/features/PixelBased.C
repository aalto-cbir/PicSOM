// $Id: PixelBased.C,v 1.3 2013/03/21 08:37:38 jorma Exp $	
...
namespace picsom {
  ...
  bool PixelBased::ProcessOptionsAndRemove(list<string>& l) {
    static const string msg = "PixelBased::ProcessOptionsAndRemove() ";
  ...
  bool PixelBased::CalculateCommon(int f, bool all, int l) {
#ifndef __MINGW32__
    cox::tictac::func tt(tics, "PixelBased::CalculateCommon");
#endif // __MINGW32__
    ...
    if (FrameVerbose())
      cout << "PixelBased::CalculateCommon(" << all << "," << l << "), wxh="
